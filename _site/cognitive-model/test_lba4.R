...
pop.mean <- c(A=.4, B.r1=.5, B.r2=.6, B.r3=.7, B.r4=.8,
              t0=.3,
              mean_v.d1.true  = 2.5,
              mean_v.d2.true  = 2.0,
              mean_v.d3.true  = 1.5,
...
pop.scale <-c(A=.1, B.r1=.1, B.r2=.1, B.r3=.1, B.r4=.1,
              t0=.05,
              mean_v.d1.true  =.2,
              mean_v.d2.true  =.2,
              mean_v.d3.true  =.2,
...
## plot(pop.prior)
## Simulate some data ----------
dat <- simulate(model, nsub = 12, nsim = 50, prior = pop.prior)
...
sigma.prior <- BuildPrior(
    ...
    p1    = c(A = 0, B.r1 = 0, B.r2 = 0, B.r3=0, B.r4=0,
              t0 = 0,
              mean_v.d1.true = 0,
              mean_v.d2.true = 0,
              mean_v.d3.true = 0,
